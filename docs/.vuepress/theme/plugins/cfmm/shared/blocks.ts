export const index = [
  ...
  },
  {
    ...
    "frontmatter": {
      ...
      "description": "Crowdfunding campaigns enable your application teams to fund the development of services they would like to see in the internal marketplace.",
      "category": "🛠 Service Ecosystem",
      "pageType": "CFMMBlock",
      "properties": {
        "enables": [],
