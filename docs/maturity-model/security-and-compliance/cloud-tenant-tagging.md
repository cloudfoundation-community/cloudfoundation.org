...
Tagging cloud tenants deliberately is useful to simplify the cloud foundation team’s operational procedures for administering a cloud platform. Tags store important metadata about a cloud tenant directly in the cloud platform’s control plane. 

> **💡** Cloud platforms can use different terms for tags like labels or annotations. In the context of the Cloud Foundation Maturity Model we refer to tags as any mechanism that allows attaching a custom **key-value** pair to a cloud tenant or resource.
...
Most cloud platforms impose technical limitations about the use of tags. Cloud Foundation teams should be aware of the following restrictions
...
- **Restricted words:** Some platforms forbid use of certain keywords, e.g. the `aws:` prefix
