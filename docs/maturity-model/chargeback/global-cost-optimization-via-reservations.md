...
Cloud Foundation teams should consider implementing this building block before looking into [Individual Project Cost Optimization via Reservation](/maturity-model/chargeback/individual-project-cost-optimization-via-reservation.md) . However, depending on the organisational philosophy (cf. [Shared Responsibility Model](/maturity-model/compliance/shared-responsibility-model.md) ) Cloud Foundation teams can also consider implement only one or both capabilities.
